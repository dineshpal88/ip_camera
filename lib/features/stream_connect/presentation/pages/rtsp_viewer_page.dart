...
import '../../../../core/platform/rtsp_player_config.dart';
import '../../../../core/platform/stream_url_utils.dart';
import '../../../../core/presentation/widgets/mjpeg_view.dart';

class RtspViewerPage extends StatefulWidget {
  const RtspViewerPage({super.key, required this.rtspUrl});

  final String rtspUrl;

  @override
  State<RtspViewerPage> createState() => _RtspViewerPageState();
}

class _RtspViewerPageState extends State<RtspViewerPage> {
  Player? _player;
