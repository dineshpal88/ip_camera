...
import '../services/detected_vehicle_repository.dart';
import '../services/vehicle_number_detector.dart';

class DetectedVehicleNumberScreen extends StatelessWidget {
  const DetectedVehicleNumberScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final repo = DetectedVehicleRepository.instance;
    final detector = createVehicleNumberDetector();

    return AnimatedBuilder(
      animation: repo,
      builder: (context, _) {
        final items = repo.detections;
